...
import { weeks, months } from "../../data/form/weeks";
...
const MasterList = () => {
  ...
  let weeksdata = weeks.map((item) => ({ value: item, label: `week ${item}` }));
    ...
    <div className="border flex text-xs flex-col gap-6 h-full sm:mx-6 lg:mx-auto lg:w-[90%] mt-6">
      ...
      <div className="border w-32">
        ...
        <FormInputDropDown
          index="z-10"
          data={weeksdata}
          onChange={(selectedValue) => setSelectedWeek(selectedValue)}
        />
      </div>
